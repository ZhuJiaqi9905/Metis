...
def cost_het_cluster(args: argparse.Namespace, gpu_cluster: GPUCluster, profile_data: Dict, model_config: ModelConfig,
    ...
    for inter_stage_plan in InterStagePlanGenerator(device_types=set(gpu_cluster.get_device_types()),
        ...
        stage_performance = StagePerformance(model_config, profile_data, gpu_cluster, inter_stage_plan, args.max_profiled_batch_size)
...
if __name__ == '__main__':
    ...
    cost_estimator = HeteroCostEstimator(profile_data, model_config, model_volume, gpu_cluster, args.max_profiled_batch_size)
    layer_load_balancer = LayerLoadBalancer(gpu_cluster, profile_data, model_config, args.gbs, args.max_profiled_batch_size)
